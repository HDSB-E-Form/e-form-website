      ...
      <SidebarFooter className="border-t border-white p-3">
        {!collapsed && (
          <>
            ...
            <button onClick={() => { navigate('/profile'); setOpenMobile?.(false); }} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent/50 text-base font-medium mt-2">
              <Settings className="h-5 w-5" /> My Profile
            </button>

            <button onClick={() => { handleLogout(); setOpenMobile?.(false); }} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent/50 text-base font-medium mt-1">
