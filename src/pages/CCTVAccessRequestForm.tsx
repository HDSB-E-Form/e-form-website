  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto animate-in slide-in-from-bottom-2 duration-500">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <section className="card-elevated p-5 sm:p-6">
          <div className="flex items-center gap-3 mb-5"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-xs font-bold text-primary">04</span><UserCheck className="h-5 w-5 text-primary" /><h2 className="font-bold text-foreground">{text("Approval", "Kelulusan")}</h2></div>
        ...
        <section className="card-elevated p-5 sm:p-6">
          <div className="flex items-center gap-3 mb-5"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-xs font-bold text-primary">05</span><ShieldCheck className="h-5 w-5 text-primary" /><h2 className="font-bold text-foreground">{text("Confidentiality Declaration", "Akuan Kerahsiaan")}</h2></div>
