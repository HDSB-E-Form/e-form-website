...
const statusBadge = (status: string) => {
  switch (status) {
    ...
    case "approved_hos":
    case "approved_hod":
      return <Badge className="bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border-0 text-[10px] font-bold tracking-wider">APPROVED</Badge>;
    case "rejected":
      return <Badge className="bg-destructive/15 text-destructive dark:text-red-400 border-0 text-[10px] font-bold tracking-wider">REJECTED</Badge>;
    case "pending":
    default:
      return <Badge className="bg-amber-500/15 text-amber-700 dark:text-amber-400 border-0 text-[10px] font-bold tracking-wider">PENDING</Badge>;
  }
};
